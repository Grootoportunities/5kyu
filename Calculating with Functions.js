...
const plus = firstNumber => secondNumber => firstNumber + secondNumber


const minus = firstNumber => secondNumber => secondNumber - firstNumber


const times = firstNumber => secondNumber => firstNumber * secondNumber


const dividedBy = firstNumber => secondNumber => Math.floor(secondNumber / firstNumber)
